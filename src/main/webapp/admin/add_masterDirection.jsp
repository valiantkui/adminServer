...
<html>
	...
	<body>
		...
		<div class="container">
			<center><h3>添加考研方向</h3></center>
			
			<form action="/adminServer/master/doAddMasterDirection" method="post" enctype="multipart/form-data" onsubmit="return ((b1+b2))==2);">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" name="type" class="form-control" id="type" value="考研" readonly="true">
			  </div>
			  <div class="form-group">
